...
@media print {
    ...
    .admin-container { padding: 0 !important; margin: 0 !important; width: 100% !important; max-width: 100% !important; }
    .admin-card { border: none !important; box-shadow: none !important; width: 100% !important; }
    .admin-table th { background: #eee !important; color: black !important; border: 1px solid #ddd; }
    .admin-table td { border: 1px solid #ddd; }
}
</style>
